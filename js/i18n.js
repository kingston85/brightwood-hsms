...
const I18N_DICT = {
  en: {
    ...
    'login.signInSub': 'Choose your role and enter your credentials.',
    'login.roleAdmin': 'Admin', 'login.roleTeacher': 'Teacher', 'login.roleStudent': 'Student / Parent',
    'login.usernameLabel': 'Username or Email', 'login.passwordLabel': 'PIN / Password',
    'login.signInBtn': 'Sign In',
    'login.demoTitle': 'Demo accounts', 'login.demoDeviceNote': '(local, this device only)',
    'login.firebaseSectionTitle': 'Shared Firebase Account', 'login.firebaseSectionNote': '(live, multi-device data)',
  ...
  fr: {
    ...
    'login.signInSub': 'Choisissez votre rôle et saisissez vos identifiants.',
    'login.roleAdmin': 'Administrateur', 'login.roleTeacher': 'Enseignant', 'login.roleStudent': 'Élève / Parent',
    'login.usernameLabel': "Nom d'utilisateur ou e-mail", 'login.passwordLabel': 'Code PIN / Mot de passe',
    'login.signInBtn': 'Se connecter',
    'login.demoTitle': 'Comptes de démonstration', 'login.demoDeviceNote': '(local, cet appareil uniquement)',
    'login.firebaseSectionTitle': 'Compte Firebase partagé', 'login.firebaseSectionNote': '(données en direct, multi-appareils)',
